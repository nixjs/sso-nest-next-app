...
export const login = () => {
    window.location.href =
        'http://localhost:3000/auth/login?client_id=localhost_3002&client_secret=08e3947a869b9cffb1f558b575726720f3821b2e21ed444ce23dc6ef503337e7&redirect_uri=http://localhost:3002/callback'
}
